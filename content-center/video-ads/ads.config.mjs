...
export const ADS = [
  ...
  },
  {
    ...
    oneOff: true,
    voice: "Christopher",
    audioOut: "product-walkthrough-vo.mp3", // "From Scattered Opportunity to Focused Action" (~110s)
    script: [
      "Nonprofits are surrounded by opportunity. But too often, that opportunity is scattered.",
      "Anansi Atlas maps the web of opportunity around your mission.",
      "Apply for the Founding Atlas Partners Pilot, tell us about your mission, and the platform gets to work.",
      "It starts with your mission. Everything maps back to it.",
      "Your Opportunity Web Snapshot opens with a 30-day action plan, ranked for your mission.",
      "Aligned funders, ranked by fit — not an endless list to sort through.",
      "The partners who make your applications competitive, mapped right beside your funders.",
      "Government pathways — the public-sector lanes most teams never have time to find.",
      "Community resources — capacity, technology, and volunteer support to strengthen your work.",
      "Your readiness, scored honestly — where you're strong, and exactly where to improve.",
      "Strategic risks — flagged early, before they cost you a quarter.",
      "Routes to capital — a living pipeline that carries every opportunity from spotted to won.",
      "And practical next steps — one clear move to make next, not a to-do avalanche.",
      "Instead of chasing scattered leads, you see exactly where to focus next.",
      "We're selecting nineteen to twenty nonprofit and mission-driven organizations for the Founding Atlas Partners Pilot.",
      "Apply at anansi atlas dot com, slash anansi atlas.",
    ],
  },
  {
