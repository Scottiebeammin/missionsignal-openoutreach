...
INTEL: dict[str, tuple[str, str]] = {
    ...
    "marketing@victimservicecenter.org": (
        ...
        "GOVERNMENT FUNDING — two SEPARATE streams; never blend them, this reader administers "
        "both and will spot the swap instantly: (1) a VOCA victim-assistance subgrant, "
        "administered by the FLORIDA ATTORNEY GENERAL'S Office (named on their own site: 'Award "
        "No. VOCA-C-2025-Victim Service Center of Central-00090 & 00161'); (2) certified rape "
        "crisis centre funding, which flows from the FLORIDA DEPARTMENT OF HEALTH through the "
        "Florida Council Against Sexual Violence — the AG has nothing to do with that stream, and "
        "FCASV also issues the certification itself. "
