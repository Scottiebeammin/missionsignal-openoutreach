...
- **`signals/views.py`** — Authenticated intake, analysis review, run-analysis POST, Mission Brief, FundingSignal dashboard, and module placeholder views. GovernmentSignal has a placeholder route for public-sector lane planning; crawling, grant search, RFP ingestion, PartnershipSignal logic, and ResourceSignal logic remain intentionally out of V2.
